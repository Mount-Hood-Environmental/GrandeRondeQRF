...
Maps depicting capacity extrapolations are useful to visualize low- versus high-capacity areas and can inform prioritization efforts. Data used to generate these maps have been exported in geopackage file format and are available in the [GrandeRondeQRF GitHub repository](https://github.com/Mount-Hood-Environmental/GrandeRondeQRF). Chinook salmon and steelhead capacity extrapolations are shown in Figures \@ref(fig:sthd-maps) and \@ref(fig:sthd-maps), respectively.
...
```{r chnk-maps, fig.cap = "Extrapolations of habitat capacity for Chinook salmon, by life-stage, for target watersheds within the Grande Ronde Basin."}
...
```{r sthd-maps, fig.cap = "Extrapolations of habitat capacity for steelhead, by life-stage, for target watersheds within the Grande Ronde Basin."}
...
Capacity limitation stuff here...
